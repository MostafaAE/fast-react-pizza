...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      'inline-block rounded-full font-semibold uppercase tracking-wide px-4 py-2.5 md:px-6 md:py-3.5 border-2 border-stone-300 text-stone-400 focus:ring-stone-200 focus:bg-stone-300 hover:bg-stone-300 hover:text-stone-800 focus:text-stone-800 transition-colors duration-300 focus:outline-none focus:ring focus:ring-offset-2 disabled:cursor-not-allowed',
